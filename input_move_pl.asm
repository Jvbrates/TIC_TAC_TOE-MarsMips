...
lw $ra, 8($sp) # store $a0 in 8($sp)
lw $a0, 4($sp) # store $a0 in 4($sp)
lw $a1, ($sp) # store $a1 in ($sp)
...
bgt, $v0, 0x30, upper_1 ## Verifica se a entradar maior que 59
j loop
...
ok:
addi $a1, $v0, -30 # 1|2|3|4|5|6|7|8 in $a1
